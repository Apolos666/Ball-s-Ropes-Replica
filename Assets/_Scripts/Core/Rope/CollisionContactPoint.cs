...
namespace Apolos.Core
{
    public class CollisionContactPoint : MonoBehaviour
    {
        ...
        //     ball.AddForce(-CalculatorDirection(other) * 5);
        // }
        //
        ...
        // {
        //     return direction.y > 0 ? Quaternion.Euler( 0, 0, 45) * _maxForceApplyX * 10 : _maxForceApplyX;
        // }
        //
        ...
        {
            var firstContactPoint = collision.GetContact(0);

            var directionCollsion = firstContactPoint.normal;
            
            print(firstContactPoint.normal);
        }
    }
}
